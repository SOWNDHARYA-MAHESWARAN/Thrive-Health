    ...
    <>
      <div className="intro container">
        <div className="banner">
          <h1>{title}</h1>
          <p>
            Thrive is a state-of-the-art facility dedicated to providing
            ...
            personalized care tailored to each patient's needs. At Thrive, we
            prioritize your well-being, ensuring a harmonious journey towards
            optimal health and wellness.
          </p>
        </div>
        <div className="banner">
          <img src={imageUrl} alt="intro" className="animated-image" />
          <span>
